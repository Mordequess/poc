#! /bin/sh
#############################################################################
# Cat3560_MRTG_CfgGen.sh written by Michael Cole 2013/08/19 for Logiq3
# ---------------------------------------------------------------------------
# Purpose:
...
IfType2Skip="Null Vlan"				# Space demlimited list of all types of interfaces we won't put in our MRTG config file
